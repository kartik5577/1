...
export const STATES_AND_DISTRICTS: StateData[] = [
  ...
  },
  {
    ...
    districts: ["Daman", "Diu", "Silvassa"].sort()
  },
  {
    name: "Delhi",
    districts: [
  ...
  },
  {
    ...
    districts: [
      ...
      "Khanti", "Koderma", "Latehar", "Lohardaga", "Pakur", "Palamu", 
  ...
  {
    name: "Puducherry",
    districts: ["Karaikal", "Mahe", "Pondicherry", "Yanam"].sort()
  },
  {
    name: "Punjab",
    districts: [
  ...
  {
    name: "Sikkim",
    districts: ["East Sikkim", "North Sikkim", "South Sikkim", "West Sikkim"].sort()
  },
  {
    name: "Tamil Nadu",
    districts: [
